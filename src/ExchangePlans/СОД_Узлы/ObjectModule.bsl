...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	Если ПротоколДоставкиОтправлений = Перечисления.СОД_ПротоколыДоставкиОтправлений.HTTPСервис Тогда
		УдалитьНепроверяемыеРеквизитыИзМассива(ПроверяемыеРеквизиты, ПланыОбмена.СОД_Узлы.ПолучитьОбязательныеРеквизитыSOAP());
	ИначеЕсли ПротоколДоставкиОтправлений = Перечисления.СОД_ПротоколыДоставкиОтправлений.WEBСервис Тогда
