...
// Параметры:
//	- Узел				- Узел, в который необходимо отправить эту регистрацию
//	- Ссылка 			- ссылка на объект в базе данных
//	- ДвоичныеДанные 	- данные, которые будут отправлены в узел
//	- УдалениеОбъекта 	- флаг определяющий, что объект был безвозвратно удален из базы данных
//	- Сеанс				- идентификатор сессии, используется когда выполняется регистрация всей таблицы для полной синхронизации
// Возврат: ссылка на объект регистрации в базе данных или пустую ссылку в случае неудачи
//
